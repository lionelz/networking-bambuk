...
The primary job of the Neutron bambuk ML2 driver is to translate requests for
resources into VM connectivity object.
...
Nothing is needed here for now.  When VM conncetivity supports DHCP, we will
need to feed this info into the VM connectivity.
